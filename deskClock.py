...
#         self.geometry("200x50+1110+750")  # Initial size and position
#         self.attributes("-topmost", True)  # Always stay on top
#         self.attributes("-transparentcolor", "white")  # Transparent background
#
#         self.label = tk.Label(self, text="", font=("Arial Black", 15),
#                               fg="#FA4934", bg="white")
...
#         self.setGeometry(1680, 1100, 300, 100)
#
#         self.label = QLabel(self)
#         self.label.setAlignment(Qt.AlignCenter)
#         self.label.setFont(QFont('Arial', 15))
#         self.label.setStyleSheet("QLabel { color : #FA6B34; }")
#         self.label.setFixedSize(280, 80)  # Adjust the size of the QLabel if necessary
#
#
#         timer = QTimer(self)
